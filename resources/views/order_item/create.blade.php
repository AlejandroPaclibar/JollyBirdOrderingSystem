...
@section('content')
    ...
    <div class="row">
        <div class="col-md-5">
            <form action="{{url('ordered_items/create')}}" method="POST">
                @csrf
                <div class="form-group">
                  <label for="order_id">Select Order</label>
                  <select name="order_id" id="order_id" class="form-select">
                      <option hidden="true">Select Order Number</option>
                      <option selected disabled>Select Order Number </option>
              ...
              <div class="form-group">
                <label for="product_id">Select Porduct</label>
                <select name="product_id" id="product_id" class="form-select">
                    <option hidden="true">Select Description</option>
